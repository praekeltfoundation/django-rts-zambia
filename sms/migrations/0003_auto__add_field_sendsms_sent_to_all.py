...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SendSMS.sent_to_all'
        db.add_column(u'sms_sendsms', 'sent_to_all',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SendSMS.sent_to_all'
        db.delete_column(u'sms_sendsms', 'sent_to_all')
    ...
    models = {
        ...
        u'sms.sendsms': {
            ...
            'sent_to_all': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sms': ('django.db.models.fields.CharField', [], {'max_length': '640'}),
