...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SendSMS.sms'
        db.alter_column(u'sms_sendsms', 'sms', self.gf('django.db.models.fields.CharField')(max_length=640))

    def backwards(self, orm):

        # Changing field 'SendSMS.sms'
        db.alter_column(u'sms_sendsms', 'sms', self.gf('django.db.models.fields.CharField')(max_length=160))
