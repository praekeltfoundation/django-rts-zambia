...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserDistrict'
        db.create_table(u'users_userdistrict', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hierarchy.District'])),
        ))
        db.send_create_signal(u'users', ['UserDistrict'])


    def backwards(self, orm):
        # Deleting model 'UserDistrict'
        db.delete_table(u'users_userdistrict')
    ...
    models = {
        ...
        u'users.userdistrict': {
            'Meta': {'object_name': 'UserDistrict'},
