...
def create_school_monitoring_data(see_lpip=random.choice(["yes", "yes_incomplete", "no"]),
                                   teaching=random.choice(["yes", "yes_incomplete", "no"]),
                                   learner_assessment=random.choice(["yes", "yes_incomplete", "no"]),
                                   learning_materials=random.choice(["yes", "yes_incomplete", "no"]),
                                   learner_attendance=random.choice(["yes", "yes_incomplete", "no"]),
                                   reading_time=random.choice(["yes", "yes_incomplete", "no"]),
                                   struggling_learners=random.choice(["yes", "yes_incomplete", "no"]),
                                   g2_observation_results=random.choice(["yes", "yes_incomplete", "no"]),
                                   ht_feedback=random.choice(["yes", "no"]),
                                   submitted_classroom=random.choice(["yes_cellphone", "yes_paper", "no"]),
                                   gala_sheets=random.choice(["yes", "yes_incomplete", "no"]),
