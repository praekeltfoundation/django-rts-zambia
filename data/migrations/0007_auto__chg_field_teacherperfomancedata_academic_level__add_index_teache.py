...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'TeacherPerfomanceData.academic_level' to match new field type.
        db.rename_column(u'data_teacherperfomancedata', 'academic_level', 'academic_level_id')
        # Changing field 'TeacherPerfomanceData.academic_level'
        db.alter_column(u'data_teacherperfomancedata', 'academic_level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.AcademicAchievementCode']))
        # Adding index on 'TeacherPerfomanceData', fields ['academic_level']
        db.create_index(u'data_teacherperfomancedata', ['academic_level_id'])


    def backwards(self, orm):
        # Removing index on 'TeacherPerfomanceData', fields ['academic_level']
        db.delete_index(u'data_teacherperfomancedata', ['academic_level_id'])


        # Renaming column for 'TeacherPerfomanceData.academic_level' to match new field type.
        db.rename_column(u'data_teacherperfomancedata', 'academic_level_id', 'academic_level')
        # Changing field 'TeacherPerfomanceData.academic_level'
        db.alter_column(u'data_teacherperfomancedata', 'academic_level', self.gf('django.db.models.fields.IntegerField')())
