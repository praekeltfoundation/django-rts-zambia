...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeacherPerformanceData.ts_number_int'
        db.add_column(u'data_teacherperformancedata', 'ts_number_int',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeacherPerformanceData.ts_number_int'
        db.delete_column(u'data_teacherperformancedata', 'ts_number_int')
    ...
    models = {
        ...
        u'data.teacherperformancedata': {
            ...
            'ts_number_int': ('django.db.models.fields.IntegerField', [], {}),
