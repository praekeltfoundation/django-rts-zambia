...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        Getting duplicate objects ordered descending, then storing them in the DuplicateStore
        models, then deleting the duplicates.
        """
        ...
        for emis in orm.HeadTeacher.objects.values_list('emis__emis', flat=True).distinct():
            ...
            for duplicate in duplicates:
                head_teacher_store = orm.HeadTeacherDuplicateStore(first_name=duplicate.first_name,
                                                      ...
                                                      is_zonal_head=duplicate.is_zonal_head,
                                                      zonal_head_name=duplicate.zonal_head_name,
