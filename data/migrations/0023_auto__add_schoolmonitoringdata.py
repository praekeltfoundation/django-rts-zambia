...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'data_schoolmonitoringdata', (
            ...
            ('see_lpip', self.gf('django.db.models.fields.CharField')(max_length=17)),
            ('teaching', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('learner_assessment', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('learning_materials', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('learner_attendance', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('reading_time', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('struggling_learners', self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True)),
            ('g2_observation_results', self.gf('django.db.models.fields.CharField')(max_length=17)),
            ('ht_feedback', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ('submitted_classroom', self.gf('django.db.models.fields.CharField')(max_length=39, null=True, blank=True)),
            ('gala_sheets', self.gf('django.db.models.fields.CharField')(max_length=17)),
            ('summary_worksheet', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ('ht_feedback_literacy', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ('submitted_gala', self.gf('django.db.models.fields.CharField')(max_length=39, null=True, blank=True)),
            ('talking_wall', self.gf('django.db.models.fields.CharField')(max_length=19, null=True, blank=True)),
    ...
    models = {
        ...
        u'data.schoolmonitoringdata': {
            ...
            'created_by_da': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data.DistrictAdminUser']", 'null': 'True', 'blank': 'True'}),
            'emis': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['hierarchy.School']"}),
            'g2_observation_results': ('django.db.models.fields.CharField', [], {'max_length': '17'}),
            'gala_sheets': ('django.db.models.fields.CharField', [], {'max_length': '17'}),
            'ht_feedback': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'ht_feedback_literacy': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'learner_assessment': ('django.db.models.fields.CharField', [], {'max_length': '17', 'null': 'True', 'blank': 'True'}),
            'learner_attendance': ('django.db.models.fields.CharField', [], {'max_length': '17', 'null': 'True', 'blank': 'True'}),
            'learning_materials': ('django.db.models.fields.CharField', [], {'max_length': '17', 'null': 'True', 'blank': 'True'}),
            'reading_time': ('django.db.models.fields.CharField', [], {'max_length': '17', 'null': 'True', 'blank': 'True'}),
            'see_lpip': ('django.db.models.fields.CharField', [], {'max_length': '17'}),
            'struggling_learners': ('django.db.models.fields.CharField', [], {'max_length': '17', 'null': 'True', 'blank': 'True'}),
            'submitted_classroom': ('django.db.models.fields.CharField', [], {'max_length': '39', 'null': 'True', 'blank': 'True'}),
            'submitted_gala': ('django.db.models.fields.CharField', [], {'max_length': '39', 'null': 'True', 'blank': 'True'}),
            'summary_worksheet': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'talking_wall': ('django.db.models.fields.CharField', [], {'max_length': '19', 'null': 'True', 'blank': 'True'}),
            'teaching': ('django.db.models.fields.CharField', [], {'max_length': '17', 'null': 'True', 'blank': 'True'})
        },
