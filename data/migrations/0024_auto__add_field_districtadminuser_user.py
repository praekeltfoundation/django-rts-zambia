...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DistrictAdminUser.user'
        db.add_column(u'data_districtadminuser', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DistrictAdminUser.user'
        db.delete_column(u'data_districtadminuser', 'user_id')
