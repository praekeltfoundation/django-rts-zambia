...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TeacherPerformanceData.ts_number'
        db.delete_column(u'data_teacherperformancedata', 'ts_number')

        # Renaming field 'TeacherPerformanceData.ts_number_int to .ts_number'
        db.rename_column(u'data_teacherperformancedata', 'ts_number_int', 'ts_number')


    def backwards(self, orm):
        # Renaming field 'TeacherPerformanceData.ts_number to .ts_number_int'
        db.rename_column(u'data_teacherperformancedata', 'ts_number', 'ts_number_int')


        # Changing field 'TeacherPerformanceData.ts_number'
        db.add_column(u'data_teacherperformancedata', 'ts_number', self.gf('django.db.models.fields.CharField')(max_length=15))
