...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SchoolData.boys'
        db.add_column(u'data_schooldata', 'boys',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'SchoolData.girls'
        db.add_column(u'data_schooldata', 'girls',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SchoolData.boys'
        db.delete_column(u'data_schooldata', 'boys')

        # Deleting field 'SchoolData.girls'
        db.delete_column(u'data_schooldata', 'girls')
