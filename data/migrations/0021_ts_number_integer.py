...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for tpdata in orm.TeacherPerformanceData.objects.all():
            tpdata.ts_number_int = int(tpdata.ts_number)
            tpdata.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        # datamigration - no backwards method
        pass
    ...
    models = {
        ...
        u'data.teacherperformancedata': {
            ...
            'ts_number_int': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
