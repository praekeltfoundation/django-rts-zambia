...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TeacherPerformanceData.pupil_engagment_score'
        db.delete_column(u'data_teacherperformancedata', 'pupil_engagment_score')

        # Adding field 'TeacherPerformanceData.pupil_engagement_score'
        db.add_column(u'data_teacherperformancedata', 'pupil_engagement_score',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TeacherPerformanceData.pupil_engagment_score'
        raise RuntimeError("Cannot reverse this migration. 'TeacherPerformanceData.pupil_engagment_score' and its values cannot be restored.")
        # Deleting field 'TeacherPerformanceData.pupil_engagement_score'
        db.delete_column(u'data_teacherperformancedata', 'pupil_engagement_score')
