...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnerPerformanceData.created_by_da'
        db.add_column(u'data_learnerperformancedata', 'created_by_da',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.DistrictAdminUser'], null=True),
                      keep_default=False)


        # Changing field 'LearnerPerformanceData.created_by'
        db.alter_column(u'data_learnerperformancedata', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.HeadTeacher'], null=True))
        # Adding field 'TeacherPerformanceData.created_by_da'
        db.add_column(u'data_teacherperformancedata', 'created_by_da',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.DistrictAdminUser'], null=True),
                      keep_default=False)


        # Changing field 'TeacherPerformanceData.created_by'
        db.alter_column(u'data_teacherperformancedata', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.HeadTeacher'], null=True))

    def backwards(self, orm):
        # Deleting field 'LearnerPerformanceData.created_by_da'
        db.delete_column(u'data_learnerperformancedata', 'created_by_da_id')


        # User chose to not deal with backwards NULL issues for 'LearnerPerformanceData.created_by'
        raise RuntimeError("Cannot reverse this migration. 'LearnerPerformanceData.created_by' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'LearnerPerformanceData.created_by'
        db.alter_column(u'data_learnerperformancedata', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.HeadTeacher']))
        # Deleting field 'TeacherPerformanceData.created_by_da'
        db.delete_column(u'data_teacherperformancedata', 'created_by_da_id')


        # User chose to not deal with backwards NULL issues for 'TeacherPerformanceData.created_by'
        raise RuntimeError("Cannot reverse this migration. 'TeacherPerformanceData.created_by' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'TeacherPerformanceData.created_by'
        db.alter_column(u'data_teacherperformancedata', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.HeadTeacher']))
