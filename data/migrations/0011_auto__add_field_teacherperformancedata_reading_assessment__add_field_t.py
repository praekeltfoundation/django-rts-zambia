...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeacherPerformanceData.reading_assessment'
        db.add_column(u'data_teacherperformancedata', 'reading_assessment',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'TeacherPerformanceData.reading_total'
        db.add_column(u'data_teacherperformancedata', 'reading_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeacherPerformanceData.reading_assessment'
        db.delete_column(u'data_teacherperformancedata', 'reading_assessment')

        # Deleting field 'TeacherPerformanceData.reading_total'
        db.delete_column(u'data_teacherperformancedata', 'reading_total')
